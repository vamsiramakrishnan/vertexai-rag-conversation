...
class RouterAgent:
    def __init__(
        ...
        index_name_id: str = "cymbal_kb_index_TH",
        ...
        self.reframe_query_chain_id = ReframeQueryChain(langcode="th")

        self.reformat_answer_chain = ReformatAnswerChain()
        self.reformat_answer_chain_id = ReformatAnswerChain(langcode="th")

        self.product_query_chain = ProductQueryChain()
        self.product_query_chain_id = ProductQueryChain(langcode="th")        
    ...
    def default_index_names(self):
        return {"en": "cymbal_kb_index_EN", "th": "cymbal_kb_index_TH"}
