...
class ChatAgent:
    ...
    def log(self, level: int, message: str) -> None:
        self.logger.log(level, f"ChatAgent - Origin: {request_origin.get()} | {message}")
    ...
    def _translate_response_if_required(self, response: str, target_language: str) -> str:
        ...
        if target_language != 'en':
            ...
            translated_response = self.translation_service.translate_text_nmt_from_src(response, "th" ,target_language)            
